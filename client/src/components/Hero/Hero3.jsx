...
//         <h1 className='text-4xl font-bold text-center mb-8 mt-10'>Frequently Asked Questions</h1>
                    ...
                    <div className='space-y-6'>
                        <div className='faq-item'>
                            ...
                            <p className='text-gray-700'>
                                This platform aims to provide comprehensive support and resources for entertainment. Additionally, it offers a dedicated FunZone for users to enjoy free entertainment through various movie clips and shows.
                        ...
                        <div className='faq-item'>
                            <h2 className='text-2xl font-semibold'>Who can I contact for additional support?</h2>
                            <p className='text-gray-700'>
                                If you need further assistance, please use the contact form on our Contact Page or email us directly at{' '}
                                <a href="aadeshsatpute375@gmail.com" className='text-blue-500 hover:underline'>
                                    aadeshsatpute375@gmail.com
                                </a>.
                            </p>
                        </div>
                    </div>

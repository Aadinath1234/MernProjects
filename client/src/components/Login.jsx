...
//         <img className='w-[100vw] h-[100vh]' src="https://cdn.mos.cms.futurecdn.net/rDJegQJaCyGaYysj2g5XWY-1200-80.jpg" alt="image " />
//       </div>
...
//        <h1 
//        className='text-3xl text-white mb-5 font-bold'
...
// it is the perfect responsive login signup page 
// import React, { useState } from 'react';
// import Header from './Header.jsx';
// import axios from 'axios';
// import toast from 'react-hot-toast';
...
//   return (
//     <div className="relative min-h-screen bg-cover bg-center" style={{ backgroundImage: 'url(https://cdn.mos.cms.futurecdn.net/rDJegQJaCyGaYysj2g5XWY-1200-80.jpg)' }}>
...
//                 className="outline-none p-3 my-1 rounded-sm bg-gray-800 text-white"
//               />
//             )}
//             <input
//               value={email}

...
//   return (
//     <div className='absolute z-10 flex w-[100vw] items-center justify-between px-5 bg-gradient-to-b from-black'>
//       <img className='w-40 mt-1 ' src={Logo} alt="netflix image " />
...
//    className='bg-red-800 text-white px-4 py-2 ml-2'>{toggle ? "Home ": "Search Movie"} </button>
//             </div>
//             </div>
//             )
//           }
